...
public class KCalendar extends ViewFlipper implements
	...
	public static final int COLOR_TX_WEEK = Color.parseColor("#ffFFFF"); // 星期标题文字颜色
	...
	public static final int COLOR_TX_OTHER_MONTH_DAY = Color
			.parseColor("#cde4fa"); // 其他月日历数字颜色cde4fa
	public static final int size = 20;// 字体大小
	...
	private String[] weekday = new String[] { "Sun", "Mon", "Tue", "Wed",
			"Thu", "Fri", "Sat" }; // 星期标题
				...
				if (i == 0 && j == 0 && weekday != 0) {
					...
					if (day <= lastDay) {
						...
						if (thisday.getDate() == day
							...
							view.setBackgroundResource(R.drawable.rili_today);
						}
